...
class GoodsController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('is_distribution', __('Is distribution'));
        $grid->column('is_agent', __('Is agent'));
        $grid->column('is_needwarrant', __('Is needwarrant'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('is_distribution', __('Is distribution'));
        $show->field('is_agent', __('Is agent'));
        $show->field('is_needwarrant', __('Is needwarrant'));
    ...
    protected function form()
    {
        ...
        $form->number('is_distribution', __('Is distribution'));
        $form->number('is_agent', __('Is agent'));
        $form->number('is_needwarrant', __('Is needwarrant'))->default(1);
